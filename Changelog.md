...
- reduced the duration and  proportionally increased the magnitude of restore health/magicka/fatigue potions to occur over 10s - combat felt like it needed to be played perfect, since potions were too slow to use as a recovery option. there are additionally already long variations of restore potions in Nosferat's Loot mod
...
## ADDED
- SM Combat Hide - doesn't have performance issues in the list anymore, probably because I've removed several mods adding new npcs everywhere over the last few updates
