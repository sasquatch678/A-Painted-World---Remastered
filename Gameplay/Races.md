...
### Argonian
﻿Passive: Poison Immunity + Waterbreathing. <br/>
﻿Power: Caustic Spit - Once per day paralyze a target for 10 seconds.

- ﻿Hestra: Caustic Spit now also makes the target 50% Weaker to Magic for 60 seconds.
- ﻿Reman: Caustic Spit now also Restores 5 Health per second for 60 seconds.
...
- ﻿Hestra: Ancestor Guardian now also creates a 15 yard radius fire storm that deals 5 damage per second for 10 seconds.
- ﻿Reman: Ancestor Guardian now also gives you 25 points of Fire Shield for 120 seconds.
- ﻿Sidri-Ashak: Ancestor Guardian now also Silences all enemies in a 15 yard radius for 120 seconds.
...
### Nord
﻿Passive: Resist Frost 50%. <br/>
﻿Power: Battle Cry - Demoralize all targets in a 25 yard radius for 60 seconds.

- ﻿Hestra: Battle Cry now also Burdens targets, rendering them unable to move for 60 seconds.
- ﻿Reman: Battle Cry now also causes 25% Weakness to Normal Weapons for 60 seconds.
...
- ﻿Sidri-Ashak: Berserk now also Fortifies Personality, Speechcraft, and Mercantile 50 points for 120 seconds.

### Redguard
﻿Passive: Fortify Fatigue 100 points. <br/>
